...
<div class="booking-form-container">
    <div class="form-card">
        <div class="form-header">
            <h2 class="form-title">📅 Request Room Booking</h2>
        ...
        <div class="user-info-box">
            ...
            <div class="user-info-text">
                Booking for: <strong>{{ auth()->user()->name }}</strong>
            </div>
        </div>

        <div class="booking-limit-box">
            <span class="booking-limit-icon">📋</span>
            <div class="booking-limit-text">
                <strong>Booking Limit Policy</strong>
                You can have a maximum of 2 approved bookings at a time. You can only apply for a new booking after the date of your existing approved bookings has passed. Rejected applications do not count towards this limit.
            </div>
        </div>

        <form method="POST" action="{{ route('user.roombooking.store') }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="input-icon" data-icon="📝" style="display: block;">
                    <textarea name="boxing_description" 
                              ...
                              class="form-textarea"
                              placeholder="Describe the purpose of this booking (e.g., Meeting, Training Session, Workshop)"
