...
<div class="form-container">
    <div class="form-card">
        ...
        <form action="{{ isset($event) ? route('admin.event.update', $event->id) : route('admin.event.store') }}" method="POST">
            @csrf
            @if(isset($event))
                @method('PUT')
            @endif
            ...
            <div class="form-group">
                ...
                <div class="location-other-field {{ old('location') == 'Other' || (isset($event) && !in_array($event->location, ['Room 1', 'Room 2', 'Room 3', 'Main Hall']) && $event->location) ? 'show' : '' }}" id="location-other-container">
                    <div class="input-wrapper">
                        <span class="input-icon">✏️</span>
                        <input 
                            type="text" 
                            ...
                            id="location_other"
                            class="form-input input-with-icon"
                            value="{{ old('location_other', (isset($event) && !in_array($event->location, ['Room 1', 'Room 2', 'Room 3', 'Main Hall']) && $event->location) ? $event->location : '') }}" 
